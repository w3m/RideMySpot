...
public class ListSpot extends BaseAdapter{
	...
	public ListSpot(Context context, List<Spot> list, Location location){
		mContext = context;
		mLocation = location;
		...
		mSensorManager.getOrientation(mMatrixOrientation, mOrientation);
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		final View view = mLayoutInflater.inflate(R.layout.list_spot_item, null);
...
//			mHeading += mUserGeoPoint.getDeclination();
			mHeading = (mBearing - mHeading) * -1; //TODO Ameliorer précision
